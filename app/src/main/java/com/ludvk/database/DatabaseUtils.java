...
import com.ludvk.activity.R.drawable;
...
public ContentValues  values;
  ...
  //添加内容
   ...
   public String getorderinfo(){
	   Cursor cursors =db.rawQuery("select * from inorderse ", null);
	   String name = null ;
	   while(cursors.moveToNext()){
			 name = cursors.getString(cursors.getColumnIndex("adress"));
			String  sex= cursors.getString(cursors.getColumnIndex("sex"));	
			String  phone= cursors.getString(cursors.getColumnIndex("phone"));
			String qq=cursors.getString(cursors.getColumnIndex("qq"));
		  }
	return name;
   }
